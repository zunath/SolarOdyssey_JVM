...
import Conversation.ViewModels.BuildToolMenuViewModel;
...
public class BuildToolMenu extends DialogBase implements IDialogHandler {
    ...
    public void Initialize() {
        ...
        BuildToolMenuViewModel model = new BuildToolMenuViewModel();
    ...
    private BuildToolMenuViewModel GetModel()
    {
        return (BuildToolMenuViewModel)GetDialogCustomData();
    }
    ...
    private void BuildMainMenuResponses(NWObject excludeObject)
    {
        ...
        BuildToolMenuViewModel model = GetModel();
