...
import Conversation.ViewModels.ConstructionSiteMenuViewModel;
import Dialog.*;
import Entities.*;
...
public class ConstructionSite extends DialogBase implements IDialogHandler {
    ...
    private void InitializeConstructionSite()
    {
        ...
        ConstructionSiteMenuViewModel model = new ConstructionSiteMenuViewModel();
    ...
    private ConstructionSiteMenuViewModel GetModel()
    {
        return (ConstructionSiteMenuViewModel)GetDialogCustomData();
    }
    ...
    private void BuildMainPage()
    {
        ...
        String header;
        ConstructionSiteMenuViewModel model = GetModel();
        StructureRepository repo = new StructureRepository();
        ...
        else
        {
            ...
            header += entity.getStoneRequired() > 0 ? entity.getStoneRequired() + "x Stone" + "\n" : "";
    ...
    {
        final ConstructionSiteMenuViewModel model = GetModel();
