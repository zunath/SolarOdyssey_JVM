...
import Conversation.ViewModels.TerritoryFlagMenuViewModel;
import Dialog.*;
...
public class TerritoryFlag extends DialogBase implements IDialogHandler {
    ...
    public void Initialize() {
        ...
        TerritoryFlagMenuViewModel model = new TerritoryFlagMenuViewModel();
    ...
    private TerritoryFlagMenuViewModel GetModel()
    {
        return (TerritoryFlagMenuViewModel)GetDialogCustomData();
    }
    ...
    {
        TerritoryFlagMenuViewModel model = GetModel();
        StructureRepository repo = new StructureRepository();
